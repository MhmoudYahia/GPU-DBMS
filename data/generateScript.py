...
# Sample with replacement from original product names
original_names = df['ProductName (T)'].tolist()
new_names = np.random.choice(original_names, size=num_new_rows, replace=True)
